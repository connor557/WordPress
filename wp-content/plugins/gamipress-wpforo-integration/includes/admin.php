...
function gamipress_wpforo_settings_meta_boxes( $meta_boxes ) {
    ...
    $meta_boxes['gamipress-wpforo-settings'] = array(
        'title' => __( 'wpForo', 'gamipress-wpforo-integration' ),
        'fields' => apply_filters( 'gamipress_wpforo_settings_fields', array(

            // Points Types

            $prefix . 'points_types' => array(
                'name' => __( 'User Points Types', 'gamipress-wpforo-integration' ),
                'desc' => __( 'Choose the points types you want to show on user reply details.', 'gamipress-wpforo-integration' ),
                'type' => 'multicheck',
                'options_cb' => 'gamipress_wpforo_points_types_option_cb',
            ),
            $prefix . 'points_types_display_title' => array(
                'name' => __( 'Display Options', 'gamipress-wpforo-integration' ),
                'desc' => __( 'Setup how points types should look on user reply details.', 'gamipress-wpforo-integration' ),
                'type' => 'title',
            ),
            $prefix . 'points_types_thumbnail' => array(
                'name' => __( 'Show Thumbnail', 'gamipress-wpforo-integration' ),
                'desc' => __( 'Show the points type featured image.', 'gamipress-wpforo-integration' ),
                'type' => 'checkbox',
                'classes' => 'gamipress-switch',
            ),
            $prefix . 'points_types_thumbnail_size' => array(
                'name' => __( 'Thumbnail Size', 'gamipress-wpforo-integration' ),
                'desc' => __( 'Set the thumbnail size (in pixels).', 'gamipress-wpforo-integration' ),
                'type' => 'text',
                'default' => '25',
            ),
            $prefix . 'points_types_label' => array(
                'name' => __( 'Show Label', 'gamipress-wpforo-integration' ),
                'desc' => __( 'Show the points type singular or plural label.', 'gamipress-wpforo-integration' ),
                'type' => 'checkbox',
                'classes' => 'gamipress-switch',
            ),
            ...
            $prefix . 'achievement_types' => array(
                'name' => __( 'User Profile Achievement Types', 'gamipress-wpforo-integration' ),
                'desc' => __( 'Choose the achievement types you want to show on user reply details.', 'gamipress-wpforo-integration' ),
                'type' => 'multicheck',
                'options_cb' => 'gamipress_wpforo_achievement_types_option_cb',
            ),
            $prefix . 'achievement_types_display_title' => array(
                'name' => __( 'Display Options', 'gamipress-wpforo-integration' ),
                'desc' => __( 'Setup how achievements should look on user reply details.', 'gamipress-wpforo-integration' ),
                'type' => 'title',
            ),
            $prefix . 'achievement_types_thumbnail' => array(
                'name' => __( 'Show Thumbnail', 'gamipress-wpforo-integration' ),
                'desc' => __( 'Show the achievement featured image.', 'gamipress-wpforo-integration' ),
                'type' => 'checkbox',
                'classes' => 'gamipress-switch',
            ),
            ...
            $prefix . 'achievement_types_title' => array(
                'name' => __( 'Show Title', 'gamipress-wpforo-integration' ),
                'desc' => __( 'Show the achievements title.', 'gamipress-wpforo-integration' ),
                'type' => 'checkbox',
                'classes' => 'gamipress-switch',
            ),
            $prefix . 'achievement_types_link' => array(
                'name' => __( 'Show Link', 'gamipress-wpforo-integration' ),
                'desc' => __( 'Add a link to the achievement page.', 'gamipress-wpforo-integration' ),
                'type' => 'checkbox',
                'classes' => 'gamipress-switch',
            ),
            $prefix . 'achievements_limit' => array(
                'name' => __( 'Number of achievements to show', 'gamipress-wpforo-integration' ),
                'desc' => __( 'Setup the number of achievements to show. Leave blank if you want to show all user earned achievement', 'gamipress-wpforo-integration' ),
                'type' => 'text',
            ),
            ...
            $prefix . 'rank_types' => array(
                'name' => __( 'User Profile Rank Types', 'gamipress-wpforo-integration' ),
                'desc' => __( 'Choose the rank types you want to show on user reply details.', 'gamipress-wpforo-integration' ),
                'type' => 'multicheck',
                'options_cb' => 'gamipress_wpforo_rank_types_option_cb',
            ),
            $prefix . 'rank_types_display_title' => array(
                'name' => __( 'Display Options', 'gamipress-wpforo-integration' ),
                'desc' => __( 'Setup how ranks should look on user reply details.', 'gamipress-wpforo-integration' ),
                'type' => 'title',
            ),
            $prefix . 'rank_types_thumbnail' => array(
                'name' => __( 'Show Thumbnail', 'gamipress-wpforo-integration' ),
                'desc' => __( 'Show the rank featured image.', 'gamipress-wpforo-integration' ),
                'type' => 'checkbox',
                'classes' => 'gamipress-switch',
            ),
            ...
            $prefix . 'rank_types_title' => array(
                'name' => __( 'Show Title', 'gamipress-wpforo-integration' ),
                'desc' => __( 'Show the ranks title.', 'gamipress-wpforo-integration' ),
                'type' => 'checkbox',
                'classes' => 'gamipress-switch',
            ),
            $prefix . 'rank_types_link' => array(
                'name' => __( 'Show Link', 'gamipress-wpforo-integration' ),
                'desc' => __( 'Add a link to the rank page.', 'gamipress-wpforo-integration' ),
                'type' => 'checkbox',
                'classes' => 'gamipress-switch',
            ),
        ) ),
...
function gamipress_wpforo_automatic_updates( $automatic_updates_plugins ) {
    ...
    $automatic_updates_plugins['gamipress-wpforo-integration'] = __( 'wpForo integration', 'gamipress-wpforo-integration' );
