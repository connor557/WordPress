...
* **Chat Logging**: Retrieve logs of your chat rooms using our custom [shortcode](https://www.iflychat.com/help/view-chat-logs?refid=wp).
...
* Activate it.
* Get [iFlyChat.com API key](https://www.iflychat.com/wordpress-chat?refid=wp). You need to first create an account [here](https://www.iflychat.com/wordpress-chat?refid=wp).
* Detailed installation steps - [https://www.iflychat.com/help/integration/wordpress/install-wordpress-chat-plugin](https://www.iflychat.com/help/integration/wordpress/install-wordpress-chat-plugin?refid=wp).
* You're done!
...
Yes, you may view our knowledge base here - [https://www.iflychat.com/help](https://www.iflychat.com/help?refid=wp).
...
We provide a URL based filter on iFlyChat settings page to show/hide chat on/from specific pages of your WordPress website. More information here - [https://www.iflychat.com/help/integration/wordpress/show-hide-popup-chat-on-specific-pages](https://www.iflychat.com/help/integration/wordpress/show-hide-popup-chat-on-specific-pages?refid=wp).
